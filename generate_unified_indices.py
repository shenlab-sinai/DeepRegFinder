...
def make_training_testing_tensors(his_dataset, seq_dataset, batch_sz):
    ...
    torch.save(h_train_loader, "./pytorch-data/sevenmark_train_dataloader.pt")
    torch.save(h_eval_loader, "./pytorch-data/sevenmark_eval_dataloader.pt")
    torch.save(h_train_loader_3cls, "./pytorch-data/sevenmark_train_dataloader_3cls.pt")
    torch.save(h_eval_loader_3cls, "./pytorch-data/sevenmark_eval_dataloader_3cls.pt")
    torch.save(s_train_loader, "./pytorch-data/sequence_train_dataloader.pt")
    torch.save(s_eval_loader, "./pytorch-data/sequence_eval_dataloader.pt")
